    ...
    <div class="mt-5 p-4">
        ...
        <div class="mt-3 p-3">
            ...
            <div>
                ...
                <div>
                    <a href="buku/detailpeminjaman.php" class="cardButton">
                        <i class="fas fa-book bookIcon"></i>
                        <span class="buttonText">Detail Peminjaman</span>
                    </a
                </div>
                <div>
                    <a href="buku/koleksibuku.php" class="cardButton">
                        <i class="fas fa-book bookIcon"></i>
                        <span class="buttonText">Koleksi Buku</span>
                    </a
                </div>
            </div>
        </div>
