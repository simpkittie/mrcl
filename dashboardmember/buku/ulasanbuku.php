...
<head>
    ...
    <style>
        ...
        .btn-tandai {
            ...
            margin-right: 5px; /* Sesuaikan jarak dengan tombol Detail */
        }
        ...
        <div class="card" style="width: 15rem;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Rating : 
                    ...
                    $query_rating = "SELECT AVG(rating) AS avg_rating FROM ulasan WHERE bukuid = {$item['id']}";
                    $result_rating = mysqli_query($conn, $query_rating);
                    $row_rating = mysqli_fetch_assoc($result_rating);
                    $avg_rating = $row_rating['avg_rating'];
                    // Tampilkan rating dengan format desimal 1 digit
            ...
            <div class="card-body">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"> <!-- Ganti action ke halaman ini sendiri -->
                    ...
                    <a class="btn btn-success" href="daftarulasan.php?id=<?= $item["id"]; ?>">Ulasan</a>
                </form>
            </div>
        </div>
    <?php endforeach; ?>
